(function () {
  ...
  var GAME_GUIDES = {
    ...
    'sunken-sixway-defense-2': {
      title: '선큰 식스웨이 디펜스 2',
      lead: '세로 화면 한 손 조작에 맞춘 타워 디펜스입니다. 짧은 배치 턴과 전투 턴이 교차하며, 같은 비용이라도 어느 라인을 먼저 살리는지가 결과를 크게 바꿉니다.',
      goal: '거점 HP를 지키면서 웨이브를 넘기고, 기본/속사/탱커/광역/해머 조합으로 안정적인 후반 운영을 만드는 것이 목표입니다.',
      controls: [
        '배치 턴: 타워 버튼 선택 후 길목 옆 빈 칸 탭',
        '전투 턴: 실시간 전투를 지켜보며 다음 배치 턴을 준비',
        '판매 모드: 배치 실수를 정리할 때만 짧게 사용'
      ],
      tips: [
        '초반에는 기본 + 속사 조합으로 빈 라인을 줄이고, 광역은 적 흐름이 모이는 구간에 늦게 올리는 편이 안정적입니다.',
        '탱커와 해머는 딜이 아니라 시간 확보용입니다. 보스나 고체력 웨이브 직전에 배치 가치가 커집니다.',
        '판매 모드를 계속 켜 두면 템포가 무너지기 쉬우므로, 턴 사이 정리용으로만 쓰는 편이 좋습니다.'
      ],
      updates: [
        '2026-03-22: 세로형 HUD 밀도를 재조정해 모바일에서 전투 영역이 더 넓게 보이도록 정리했습니다.',
        '2026-03-22: 종료 모달과 오디오 토글을 보강해 짧은 세션 종료 흐름을 명확히 했습니다.'
      ],
      faq: [
        { q: 'Q. 초반부터 광역 타워를 서두르면 좋은가요?', a: 'A. 보통은 아닙니다. 초반은 라인 수습이 먼저라서 저비용 조합이 더 안정적입니다.' },
        { q: 'Q. 후반에 돈이 남는데도 뚫립니다.', a: 'A. 화력 부족보다 배치 위치가 겹쳐 경로 제어가 무너지는 경우가 많습니다. 라인 분산을 먼저 보세요.' }
      ]
    },
    'worm-arena-rush': {
    ...
    'resonance-district': {
      title: '잔향동',
      lead: '텍스트 설명을 거의 쓰지 않는 무언극형 퍼즐 호러입니다. 조명, 음향, 사물 배치만으로 다음 행동을 읽게 만드는 것이 핵심 의도입니다.',
      goal: '챕터별 공간을 돌파하며 잔향을 모으고 출구까지 도달하세요. 빠른 액션보다 장면 해석과 점프 타이밍이 더 중요합니다.',
      controls: [
        'PC: A/D 또는 방향키 이동, W 또는 Space 점프',
        '모바일: 하단 좌우/점프 버튼 사용',
        '사운드와 빛 변화가 힌트 역할을 하므로 이어폰 또는 스피커 켜기를 권장'
      ],
      tips: [
        '막히는 구간에서는 발판보다 먼저 배경음과 깜빡이는 광원을 보세요. 다음 동선 힌트가 들어 있습니다.',
        '긴 점프보다 짧은 점프 두 번이 안전한 구간이 많습니다. 공포 연출 때문에 서두르면 오히려 데스가 늘어납니다.',
        '데스 수는 실패 기록이 아니라 학습 흔적에 가깝습니다. 같은 구간에서 무엇이 바뀌는지 관찰하는 편이 빠릅니다.'
      ],
      updates: [
        '2026-03-24: 챕터별 무드 전환과 사운드 출처 표기를 정리해 플레이 맥락을 더 명확히 했습니다.',
        '2026-03-24: 모바일 터치 버튼 간격과 메시지 노출 타이밍을 조정했습니다.'
      ],
      faq: [
        { q: 'Q. 다음에 어디로 가야 하는지 잘 모르겠습니다.', a: 'A. 이 게임은 화살표 대신 장면 변화로 길을 안내합니다. 배경 광원과 새로 열린 발판을 함께 보세요.' },
        { q: 'Q. 공포 게임인가요, 퍼즐 게임인가요?', a: 'A. 점프 액션 위에 공포 연출을 얹은 퍼즐 플랫폼에 가깝습니다. 난이도 핵심은 반응속도보다 해석입니다.' }
      ]
    },
    'tokki-pudding-bar': {
      title: '토끼푸딩 바',
      lead: '서빙 콘셉트를 입힌 세로형 물리 머지 게임입니다. 귀여운 외형보다 드롭 위치 조절과 다음 피스 예측이 점수 차이를 만듭니다.',
      goal: '같은 디저트를 합쳐 더 큰 메뉴를 만들고, 보드 상단까지 넘치지 않도록 오래 버티며 최고 점수를 갱신하세요.',
      controls: [
        '터치 또는 마우스로 드롭 위치를 정한 뒤 놓기',
        '집중 버튼으로 안내 UI를 줄여 보드 집중도를 높일 수 있음',
        '현재 점수, 최고 기록, 다음 피스를 상단 HUD에서 즉시 확인'
      ],
      tips: [
        '초반에는 중앙 정렬보다 좌우 벽을 이용한 정리 플레이가 안정적입니다.',
        '다음 피스를 보고 미리 빈 공간을 만들면 고레벨 합성 타이밍이 훨씬 쉬워집니다.',
        '높은 층에서 무리하게 큰 합성을 노리기보다, 중간층을 낮게 유지하는 편이 장기적으로 점수가 잘 나옵니다.'
      ],
      updates: [
        '2026-03-23: 드롭 위치 가시성과 상단 HUD 간격을 조정해 세로 화면에서 시야를 넓혔습니다.',
        '2026-03-23: 종료 확인 시트와 오디오 토글 흐름을 다듬어 짧은 반복 플레이 템포를 정리했습니다.'
      ],
      faq: [
        { q: 'Q. 같은 조각인데 왜 바로 안 합쳐지나요?', a: 'A. 충돌 각도와 흔들림 때문에 완전히 닿기 전까지는 잠깐 버티는 경우가 있습니다. 벽면 정리 후 떨어뜨리면 더 안정적입니다.' },
        { q: 'Q. 고득점 핵심은 무엇인가요?', a: 'A. 큰 조각을 빨리 만드는 것보다 상단 높이를 낮게 유지하며 연속 합성 기회를 남기는 운영이 더 중요합니다.' }
      ]
    },
    'retro-hero-street-beat': {
      title: 'Retro Hero: Street Beat',
      lead: '레인형 리듬 액션이지만 단순 박자 맞추기보다 SAFE 판정과 히어로 게이지 운영이 중요합니다. 완벽 판정만 노리면 오히려 콤보가 끊길 수 있습니다.',
      goal: '트랙을 끝까지 완주하며 콤보와 정확도를 유지하고, HERO MODE를 열어 점수 배수를 크게 올리는 것이 목표입니다.',
      controls: [
        '모바일: 하단 LEFT/CENTER/RIGHT 버튼 탭',
        '트랙 선택 좌우 화살표로 곡 변경, 난이도 버튼으로 EASY/NORMAL/HARD 전환',
        '5초 미리듣기로 BPM과 패턴 밀도를 먼저 파악 가능'
      ],
      tips: [
        '처음 보는 곡은 Perfect보다 SAFE 유지에 집중하는 편이 더 좋은 결과로 이어집니다.',
        '히어로 게이지는 곡 전체에 나눠 쓰기보다 패턴이 몰리는 구간 직전에 여는 편이 효율적입니다.',
        '판정이 자꾸 늦으면 입력 보정보다 화면 노트 위치를 한 박자 먼저 보는 습관이 더 중요합니다.'
      ],
      updates: [
        '2026-03-28: 트랙 셀렉트와 결과 히스토그램을 보강해 곡별 차이를 더 읽기 쉽게 정리했습니다.',
        '2026-03-28: 모바일 버튼 간격과 SAFE 판정 체감을 조정해 짧은 세션 재도전을 쉽게 만들었습니다.'
      ],
      faq: [
        { q: 'Q. SAFE도 콤보가 이어지나요?', a: 'A. 네. SAFE는 저점수 통과 판정이라 콤보는 유지되지만, 장기 점수 효율은 Perfect/Great보다 낮습니다.' },
        { q: 'Q. 어떤 곡으로 시작하는 게 좋나요?', a: 'A. BPM이 낮고 패턴 반복이 분명한 트랙으로 시작해 레인 전환 감각을 익힌 뒤 난도를 올리는 편이 좋습니다.' }
      ]
    },
    'cassette-ab-world': {
      title: 'Cassette A/B World',
      lead: '한 번의 탭으로 규칙 전체를 뒤집는 A/B 전환형 원탭 게임입니다. 움직임보다 상태 전환 타이밍이 게임 전체 난도를 결정합니다.',
      goal: '59초 동안 월드 A와 B를 오가며 반대 월드 게이트만 통과하고, 실수 없이 최대 점수를 유지하는 것이 목표입니다.',
      controls: [
        '탭 또는 스위치 버튼으로 월드 A/B 전환',
        '현재 월드는 HUD와 하단 스위치에서 동시에 확인 가능',
        '런 종료 후 바로 다시 시작해 패턴 적응 반복 가능'
      ],
      tips: [
        '게이트 직전 반응보다 한 템포 이른 전환이 안정적입니다. 마지막 순간 입력은 실수 확률이 높습니다.',
        '지금 월드보다 다음 게이트 색을 먼저 보는 습관을 들이면 패턴이 단순해집니다.',
        '점수에 급해 연속 전환을 남발하면 리듬이 무너집니다. 짧은 규칙 루프로 읽는 편이 훨씬 쉽습니다.'
      ],
      updates: [
        '2026-03-23: 월드 스위치 HUD와 종료 모달 문구를 정리해 규칙 이해 속도를 높였습니다.',
        '2026-03-23: 59초 런 구조에 맞춰 피드백 이펙트와 탭 반응 타이밍을 다듬었습니다.'
      ],
      faq: [
        { q: 'Q. 왜 같은 색 게이트에 닿으면 바로 실패하나요?', a: 'A. 이 게임의 핵심 규칙이 “같은 월드는 충돌, 반대 월드는 통과”이기 때문입니다. 전환 자체가 회피 수단입니다.' },
        { q: 'Q. 초반은 쉬운데 후반이 갑자기 어렵습니다.', a: 'A. 후반에는 패턴 속도보다 판단 리듬이 촘촘해집니다. 화면 중앙보다 다음 게이트 순서를 먼저 읽는 것이 중요합니다.' }
      ]
    },
    'poop-escape': {
      title: 'Poop Escape',
  ...
  function ensureFooterLinks() {
    ...
    if (!footer) {
      ...
      footer.className = 'site-quality-footer';
