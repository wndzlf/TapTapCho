(function () {
  ...
  var GAME_GUIDES = {
    ...
    'crimson-hunter-trials': {
      ...
      updates: [
        '2026-03-14: 모바일 가상스틱 입력 감도를 안정화했습니다.',
        '2026-03-14: Trial 단계별 적 밀도를 조정해 난이도 점프를 완화했습니다.'
      ],
      faq: [
    ...
    'worm-arena-lan': {
      title: 'Worm Arena LAN',
      lead: '같은 네트워크에서 룸을 열어 붙는 멀티 웜 아레나입니다. 성장 속도보다 상대 동선을 먼저 읽는 심리전 비중이 큽니다.',
      goal: '먹이를 모으며 몸집을 키우고, 상대의 진행 라인을 끊어 충돌을 유도하세요. 생존 시간과 처치 기회를 함께 관리하는 것이 포인트입니다.',
      controls: [
        '방향키/WASD 또는 터치 조작',
        '방 입장 후 Ready 상태에서 시작',
        '부스트 입력은 짧게 끊어 써야 손실이 적음'
      ],
      tips: [
        '초반에는 정면 대결보다 먹이 밀집 구역 선점이 유리합니다.',
        '상대 머리 앞을 크게 가로막기보다 탈출 각을 좁히는 식으로 압박하세요.',
        '네트워크 지연이 있는 방에서는 급회전보다 완만한 곡선 운영이 안정적입니다.'
      ],
      updates: [
        '2026-03-14: 룸 동기화 안정성을 다듬어 재접속 복구가 더 매끄러워졌습니다.',
        '2026-03-14: 모바일 UI 버튼 크기를 키워 멀티 입력 실수를 줄였습니다.'
      ],
      faq: [
        { q: 'Q. 왜 내 화면과 상대 위치가 조금 다르게 보이나요?', a: 'A. LAN 동기화 보정이 들어가므로 순간 위치보다 진행 방향 예측이 더 중요합니다.' },
        { q: 'Q. 부스트를 계속 쓰면 왜 손해인가요?', a: 'A. 성장 자원을 깎아먹기 때문에 짧은 교전 이득 외에는 유지 효율이 크게 떨어집니다.' }
      ]
    }
  };
