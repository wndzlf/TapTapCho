...
async function buildZigzagMemoryRunWebBundle() {
  ...
  await writeTransformedFile(
    ...
    (contents) =>
      contents
        .replace("new Audio('../assets/audio/zigzag-memory-run-pixabay-488126.mp3')", "new Audio('./assets/audio/zigzag-memory-run-pixabay-488126.mp3')")
