const bgmAudio = window.TapTapNeonAudio?.create('webgame-13', document.querySelector('.hud'), { theme: 'neon', showSfxToggle: false });
...
const BEST_COMBO_KEY = 'color-switch-dot-best-combo';
...
function updateHud() {
  ...
  bestComboEl.textContent = `x${(1 + Math.min(1.4, bestCombo / 5)).toFixed(1)}`;
