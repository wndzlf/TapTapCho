...
async function buildOfficetelWatchWebBundle() {
...
buildOfficetelWatchWebBundle().catch((error) => {
  console.error('[officetel-watch/toss-package] Failed to prepare web bundle.');
  console.error(error);
  process.exit(1);
});
