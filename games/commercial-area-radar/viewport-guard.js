(() => {
  ...
  window.addEventListener("resize", syncViewportMeta);
  window.addEventListener("orientationchange", syncViewportMeta);
  window.visualViewport?.addEventListener("resize", syncViewportMeta);
