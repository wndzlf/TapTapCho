...
- 부제: `같은 푸딩을 붙여 연쇄 합체하는 말랑 드롭 퍼즐`
- 상세 설명:
  `토끼푸딩 바는 한 손으로 즐기는 세로형 드롭 퍼즐입니다. 화면을 눌러 푸딩을 떨어뜨리고 같은 종류를 붙여 더 큰 디저트로 합체시키세요. 잔이 넘치기 전에 연쇄 합체를 이어가며 최고 점수에 도전할 수 있습니다.`
- 앱 검색 키워드:
  `퍼즐게임, 머지게임, 드롭퍼즐, 캐주얼게임, 한손게임`
