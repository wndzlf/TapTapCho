(() => {
  ...
  // games/retro-hero-street-beat/toss-bridge-source.js
    ...
    "games/retro-hero-street-beat/toss-bridge-source.js"() {
      ...
      function logBridgeWarning(method, error) {
        if (typeof console !== "undefined" && console.warn) {
          console.warn(`[Sunken Sixway Defense 2 Toss Bridge] ${method} failed`, error);
        }
      }
      ...
      function subscribeToBridge(method, bridgeSubscribe, listener, options, errorListener) {
        ...
        try {
          return bridgeSubscribe({
            ...
            onError: (error) => {
              logBridgeWarning(method, error);
              errorListener == null ? void 0 : errorListener(error);
            }
          });
        } catch (error) {
          logBridgeWarning(method, error);
      ...
      window.SunkenSixwayDefense2Toss = {
        isAvailable() {
